...
export class SpinningWheelInitService implements OnApplicationBootstrap {
    ...
    constructor(private readonly prisma: PrismaService, private readonly spinnigWheelService: SpinnigWheelService, private readonly spinnigWheelRewardService: SpinnigWheelRewardService) { }
    ...
    async onApplicationBootstrap() {
        ...
        if (!spinnigWheel)
            spinnigWheel = await this.spinnigWheelService.create({ name: 'Spinnig Wheel' });
