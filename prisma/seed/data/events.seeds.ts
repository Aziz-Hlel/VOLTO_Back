import { EntityType, Event, EventType, Media, MediaStatus, PrismaClient } from "@prisma/client";
import { randomUUID } from "crypto";
import { fridayBrunchThumbnail, fridayBrunchVideo, hookasNightThumbnail, hookasNightVideo, LadiesNightThumbnail, LadiesNightVideo, newYearEveThumbnail, newYearEveVideo, seedMedia } from "./media.seeds";
